...
csv_file = 'kickout.csv'  # Replace with the path to your CSV file
...
title = "Thershold of reputation of deciding kickout of agents"
...
ax1.set_xlabel('Kickout Threshold')
